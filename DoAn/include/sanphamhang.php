<?php
    ...
    $sql_nsx1 = mysqli_query($con,"SELECT * FROM sanpham, nhasx where sanpham.mansx=nhasx.mansx AND sanpham.mansx='$id' ");
    $sql_nhasx = mysqli_query($con,"SELECT * FROM sanpham, nhasx where sanpham.mansx=nhasx.mansx AND sanpham.mansx='$id' ");

    $sql_tenhang =  mysqli_fetch_array($sql_nhasx);
    $tenhang = $sql_tenhang['tennsx'];

?>
<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3"><?php echo $tenhang ?>
            </h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
							<?php
								while($value = mysqli_fetch_array($sql_nsx1)){
								?>
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img height="80%" width="80%" src="admin/resources/img/<?php echo $value['hinh'] ?>" alt="">

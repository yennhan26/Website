<?php
    ...
    $sql_sp = mysqli_query($con,"SELECT * FROM sanpham, loaisp where sanpham.maloai=loaisp.maloai AND sanpham.maloai='$id' ");
    $sql_sanpham = mysqli_query($con,"SELECT * FROM sanpham, loaisp where sanpham.maloai=loaisp.maloai AND sanpham.maloai='$id' ");

    $sql_ten = mysqli_fetch_array($sql_sanpham);
    $ten = $sql_ten['tenloai'];
?>
<div class="ads-grid py-sm-5 py-4">
		<div class="container py-xl-4 py-lg-2">
			<!-- tittle heading -->
			<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3"><?php echo $ten ?>
            </h3>
			<!-- //tittle heading -->
			<div class="row">
				<!-- product left -->

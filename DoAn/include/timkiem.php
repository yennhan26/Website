<?php
    if(isset($_POST['timkiem'])){
		$tukhoa = $_POST['tukhoa'];
		$sql_tk = mysqli_query($con,"SELECT * FROM sanpham join nhasx on sanpham.mansx=nhasx.mansx WHERE  tensp LIKE '%$tukhoa%'");
	}
?>
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<div class="row">
							<?php
								while($value = mysqli_fetch_array($sql_tk)){
							?>
